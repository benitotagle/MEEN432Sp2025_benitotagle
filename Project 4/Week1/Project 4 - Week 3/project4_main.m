...
mass = 1600;            % [kg] - Vehicle mass
rw = 0.3;               % [m] - Wheel radius
vm = 1600;              % [kg] - (Unused duplicate of mass)
iw = 0.5 * 7 * rw^2;    % [kg·m²] - Wheel moment of inertia (7 kg wheel)
ipt = 10;               % [kg·m²] - Driveline/powertrain inertia
cd = 0.36;              % [-] - Aerodynamic drag coefficient
ad = 2.6;               % [m²] - Frontal area
tau_brakes = 50000;     % [Nm] - Max brake torque
tau_motor = 800;        % [Nm] - Max drive torque
gratio = 3;             % [-] - Gear ratio (motor to wheel)
i_gear_i = 0.5;         % [kg·m²] - Gear input inertia
o_gear_i = 0.7;         % [kg·m²] - Gear output inertia
...
b_capacity = 150;       % [Ah] - Battery pack capacity
